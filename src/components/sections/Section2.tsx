...
const Section2 = () => {
  return (
    <section className="bg-default-green" id="2">
      <Wrapper>
        <div className="flex flex-col justify-between">
          ...
          />
          <h3 className="text-center font-roboto text-xl w-[700px] mx-auto my-[25px]">
          ...
          <h1 className="text-center font-roboto text-[25px] font-bold mx-auto">
